...
\subsubsection{Demo \& Links}
\begin{itemize}
\item \inlineicon{ludika.png} \href{https://ludika.modica.io}{ludika.modica.io}: the live platform
\item \inlineicon{fastapi.png} \href{https://ludika.modica.io/api/v1/docs}{Live API Documentation}: the OpenAPI documentation for the API, which can be used to interact with the platform programmatically.
\item \inlineicon{github.png} \href{https://github.com/TheManchineel/ludika}{TheManchineel/ludika}: the source code for the project, available on GitHub.
\end{itemize}
