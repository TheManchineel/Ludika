    ...
    return ChatPromptTemplate.from_messages(
        [
         ...
         Always use the tools when asked to perform database operations.""",
            ...
            4. Use `google_search` and `wikipedia` to find more information about the game and choose all the appropriate tags that apply. If you don't have enough information, stop and do not create a game.
